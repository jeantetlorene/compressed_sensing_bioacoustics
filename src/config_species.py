...
base_data_path = str((Path(__file__).parent.parent / "Data").resolve())

species_settings = {
    "gibbon": {
        "data": {
            "species_folder": Path(os.path.join(base_data_path, "Gibbon")),
    ...
    "thyolo": {
        "data": {
            "species_folder": Path(os.path.join(base_data_path, "Thyolo")),
    ...
    "ptw": {
        "data": {
            "species_folder": Path(os.path.join(base_data_path, "PTW")),
            "positive_class": "PTW",
            "negative_class": "NOISE",
        },
        "preprocessing": {
    ...
    "bats": {
        "data": {
            "species_folder": Path(os.path.join(base_data_path, "Bats")),
            "positive_class":"" ,
            "negative_class": "",
        },
        "preprocessing": {
